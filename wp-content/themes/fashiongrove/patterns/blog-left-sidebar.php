<?php
  ...
  * Slug: fashiongrove/blog-left-sidebar
  */
?>
...
<h1 class="wp-block-heading alignwide" style="margin-bottom:0;font-size:32px;font-style:normal;font-weight:600"><?php echo esc_html__( ' Blog & Articles ', 'fashiongrove' ); ?></h1>
<!-- /wp:heading --></div></main>
<!-- /wp:cover -->
