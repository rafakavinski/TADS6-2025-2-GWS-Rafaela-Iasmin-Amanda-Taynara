<?php
  ...
  * Slug: fashiongrove-trendy/blog-left-sidebar
  */
?>
...
<p class="has-text-align-center"> <?php echo esc_html__( ' No posts found ', 'fashiongrove-trendy' ); ?>  </p>
<!-- /wp:paragraph -->
