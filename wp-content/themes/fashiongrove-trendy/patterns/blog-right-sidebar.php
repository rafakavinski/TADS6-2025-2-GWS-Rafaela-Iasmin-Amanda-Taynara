<?php
 /**
  * Title: Post
  * Slug: fashiongrove-trendy/blog-right-sidebar
  * Inserter: no
  */
?>
...
<h2 class="wp-block-heading alignwide" style="margin-bottom:0;font-size:32px;font-style:normal;font-weight:600"><?php echo esc_html__( 'News & Articles ', 'fashiongrove-trendy' ); ?></h2>
<!-- /wp:heading --></div></main>
<!-- /wp:cover -->
