...
class Trendy_Fashion_Outfits {
	...
	private function load_dependencies() {
		...
		require_once TRENDY_FASHION_OUTFITS_PATH . 'notice-getstart/alpha-getstart.php';

		/**The class responsible for defining all actions that occur in the admin area.*/
		require_once TRENDY_FASHION_OUTFITS_PATH . 'notice-getstart/index.php';
	}
}